...
Scenario: Insert the Teacher Marked Spec to Database.
    * def spec_read = read("classpath:cqubeApp/cqube_api/Request_Data/"+state_code+"/Schema/Teacher-Attendance/teachersmarked.json")
    * print spec_read
...
Scenario: Insert the Teachers Present Spec to Database.
    * def spec_read = read("classpath:cqubeApp/cqube_api/Request_Data/"+state_code+"/Schema/Teacher-Attendance/teacherspresent.json")
    * print spec_read
    And request spec_read    
    When method post
    * print response
...
Scenario: Insert the Total Teachers Spec to Database.
    * def spec_read = read("classpath:cqubeApp/cqube_api/Request_Data/"+state_code+"/Schema/Teacher-Attendance/totalteachers.json")
    * print spec_read
    And request spec_read  
    When method post
    * print response
